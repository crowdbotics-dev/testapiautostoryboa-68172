...
## Project Structure
    ...
    ├── testapiautostoryboa_68172  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_68172`
...
2. Clone this repo and `cd testapiautostoryboa_68172`
